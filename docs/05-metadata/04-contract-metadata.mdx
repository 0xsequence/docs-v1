...
Our Metadata API service is now managed through **Sequence Builder.** Usage is charged in credits - issued monthly based your subscription plan. Signup to grab your API access key. 
