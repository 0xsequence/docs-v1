...
title: Payments
hide_title: true
slug: /builder-payments/overview
---


# Payments in Builder

Sequence Builder offers a comprehensive onramp dashboard that provides you with all the information needed to manage your node infrastructure, from compatibility with your favorite Web3 module to your requirement for real-time performant data for your game.
