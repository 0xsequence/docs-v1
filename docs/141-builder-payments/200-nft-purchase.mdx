---
title: Buy NFTs with Credit Cards
hide_title: true
slug: /builder-payments/nft-purchase
---


# How to Buy NFTs with Credit Cards in Builder

In this walkthrough, we will show you how to refill your gas tank in Builder with a credit card. Gas is used to [sponsor gas for contracts](/guides/sponsor-contract-gas-tank) and manage your relayers, so it's important to know how to keep your tank full.

### Prerequisite: Sign up and Create a Project

This guide assumes that you have already [signed up for Builder and created a Project](/guides/signup-and-create-a-project). It's also worth noting that you need a smart contract to use gas on a sponsor. Deploying contracts on Builder is easy, and you [can learn how to do so here](https://docs.sequence.xyz/builder/deploy-an-item-collection-contract).
...
![Sequence builder select project refill gas](/img/builder/builder_select_project_refill_gas.png)

Then click on the Gas Tank section.


![Sequence builder go to tank refill gas](/img/builder/builder_go_to_tank_refill_gas.png)
...
![Sequence builder click add refill gas](/img/builder/builder_click_add_refill_gas.png)
...
![Sequence builder refill amount refill gas](/img/builder/builder_refill_amount_refill_gas.png)
...
![Sequence builder builder creditcard checkout refill gas](/img/builder/builder_creditcard_checkout_refill_gas.png)
...
![Sequence builder refill success refill gas](/img/builder/builder_refill_success_refill_gas.png)
