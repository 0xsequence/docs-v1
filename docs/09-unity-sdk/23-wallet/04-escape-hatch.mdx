...
As you're working with more advanced Sequence interactions, you may find that the provided APIs are not expressive enough for your use case.

As a last resort, there is a function `ExecuteSequenceJS` and its sister function `ExecuteSequenceJSAndParseJSON`.
