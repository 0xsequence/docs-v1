---
title: Create your embedded Marketplace
hide_title: true
slug: /builder-marketplaces/create-embedded-marketplace
---


# How to Create your embedded Marketplace

This guide walks through how to setup and deploy a contract on Builder. If you haven't yet done so, make sure you have [signed up for Builder and created a Project](/guides/signup-and-create-a-project).


## Step 1: Go to the Marketplace section
