...
const serviceList = [
  ...
  { network: 'BSC (BNB Smart Chain)', logo: '/img/networks/56.png', endpoint: 'https://bsc-indexer.sequence.app' },
  { network: 'Gnosis', logo: '/img/networks/64.png', endpoint: 'https://gnosis-indexer.sequence.app' }
]
const testServiceList = [
  { network: 'Rinkeby', logo: '/img/networks/1.png', endpoint: 'https://mainnet-indexer.sequence.app' },
  { network: 'Mumbai', logo: '/img/networks/137.png', endpoint: 'https://polygon-indexer.sequence.app' },
  { network: 'BSC Testnet', logo: '/img/networks/56.png', endpoint: 'https://bsc-indexer.sequence.app' }
]
