...
Triggered upon successful execution of a [send transaction intent](/waas/implementation/payloads#send-transaction-payload). The code for this response is `transactionReceipt`.
...
| request        | [SendTransactionPayload](https://docs.sequence.xyz/waas/implementation/payloads/#send-transaction-payload)| The original request packet of the transaction       | No       |
...
Triggered upon failed to execute a [send transaction intent](/waas/implementation/payloads#send-transaction-payload). The code for this response is `transactionFailed`.
...
| request             | [SendTransactionPayload](https://docs.sequence.xyz/waas/implementation/payloads/#send-transaction-payload)      | The packet of transactions that were attempted.              |
...
Triggered after a successful [sign message intent](/waas/implementation/payloads#sign-message-payload). The code is `signedMessage`.
...
Occurs after successfully executing an [open session intent](/waas/implementation/payloads#open-session-payload). The code is `sessionOpened`.
