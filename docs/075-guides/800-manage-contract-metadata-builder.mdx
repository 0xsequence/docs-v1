...
Click on "Content Preview" next to the folder you created on Pinata. This will open a new tab showing all your uploaded JSON files. Copy the URL of this folder.
...
- `mint` does what it says on the tin. It mints one of your tokens and sends it to an address of your choosing.
...
This is in the format: `https://dev-metadata.sequence.app/tokens/<chain-name>/<contract-address>/<token-id>/refresh`

## Conclusion
You've successfully minted your own ERC1155 game tokens using Sequence Builder.
