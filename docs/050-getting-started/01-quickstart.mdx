...
`projectAccessKey` is required which can be generated in the [Sequence Builder](https://sequence.build) by creating a project and accesssing Settings to retrieve API Access Keys.
