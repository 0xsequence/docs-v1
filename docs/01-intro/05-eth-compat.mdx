...
We ❤️ the Ethereum ecosystem

<img src='/img/eth-love.jpg' />

Our goal is to support Ethereum by building compatible systems and tools to extend the capabilities of any
...
additional capabilities while maintaining compatability to Ethereum protocols, standards and contracts.

Bring your own tools, combine them with Sequence, and help grow Web3 by delivering new and amazing experiences
for users on the Web. Aka, sequence is compatible with with all existing Ethereum web libraries such as [Ethers.js](https://docs.ethers.io/v5/),
[Web3js](https://web3js.readthedocs.io/), and all other contracts, libraries and products that
maintain compatibility to Ethereum standards.
