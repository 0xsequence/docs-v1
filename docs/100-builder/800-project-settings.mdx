...
1. **General**: Update your [project name](/builder/settings-collaborators#project-name) or [avatar](/builder/settings-collaborators#avatar)
2. **Collaborators**: Add [collaborators](/builder/settings-collaborators#add-a-collaborator) or create [invite links](/builder/settings-collaborators#create-an-invite-link)
3. **Networks**: Update the [networks](/builder/settings-collaborators#3-network-settings) your project is using
4. **API Access Keys**: Create [new keys](/builder/settings-collaborators#create-a-new-api-access-key) and [configure existing keys](/builder/settings-collaborators#update-api-access-settings-of-a-key)
5. **Billing**: Update your [project plan](/builder/settings-collaborators#update-your-project-subscription-plan) or set [overage limits](/builder/settings-collaborators#set-your-overage-limit)

The final action you can take in settings is to [delete your project](/builder/settings-collaborators#delete-a-project).
...
You can either follow this below section, or, skip ahead to the [video](/builder/settings-collaborators#watch-how-to-invite-collaborators) for inviting collaborators.
...
To add a collaborator, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [Collaborators](/builder/settings-collaborators#2-collaborator-settings) section.
...
To create an invite link, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [Collaborators](/builder/settings-collaborators#2-collaborator-settings) section.
...
- [rename](/builder/settings-collaborators#renaming-your-key) or [delete](/builder/settings-collaborators#deleting-your-key) your key
- [copy](/builder/settings-collaborators#copy-your-key) or [change](/builder/settings-collaborators#rotate-your-key) the credentials of your key
- configure [how](/builder/settings-collaborators#set-service-access) and [where](/builder/settings-collaborators#set-domain-access) your key can be used

### Create a new API Access Key

To create a new API Access Key, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [API Access Key](/builder/settings-collaborators#4-api-access-keys-settings) section.
...
To rename or delete one of your keys, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [API Access Key](/builder/settings-collaborators#4-api-access-keys-settings) section.
...
To access the credentials of a key, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [API Access Key](/builder/settings-collaborators#4-api-access-keys-settings) section.
...
To update API access settings of a key, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [API Access Key](/builder/settings-collaborators#4-api-access-keys-settings) section.
...
You can also [update your subscription](/builder/settings-collaborators#update-your-project-subscription-plan), and [set your overage limits](/builder/settings-collaborators#set-your-overage-limit).
...
To update your project subscription plan, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [Billing](/builder/settings-collaborators#5-billing-settings) section.
...
To set your overage limit, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project), accessed [Settings](/builder/settings-collaborators#go-to-settings), and are in the [Billing](/builder/settings-collaborators#5-billing-settings) section. you will also need a paid plan to set an overage limit.
...
To delete your project, make sure you have selected the [correct project](/builder/settings-collaborators#select-a-project) and are in the [Settings](/builder/settings-collaborators#go-to-settings) section. You will also need administrative-level permissions to delete a project. 
