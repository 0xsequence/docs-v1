...
This guide walks through how to setup and deploy a contract on Builder. If you haven't yet done so, make sure you [configured a project on Builder first with API access keys](/getting-started/get-access-key-in-builder).
