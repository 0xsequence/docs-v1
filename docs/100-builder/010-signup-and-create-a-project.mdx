...
<CardList items={[
  ...
  },
  {
    ...
    route: '/deploy-an-item-collection-contract',
  },
  {
...
// x builder_start_building_signup_project.png

// builder_choose_signin_signup_project.png
// builder_choose_signin_signup_project.png

// x builder_more_signin_signup_project.png

// x builder_enter_email_signup_project.png

// x builder_copy_code_signup_project.png

// x builder_enter_code_signup_project.png

// x builder_return_screen_signup_project.png
...
// x builder_lookup_contract_signup_project.png
