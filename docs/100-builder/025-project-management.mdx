...
##### Avatar
Upload a custom `avatar` to your project that displays aspects of your identity you want to be included as part of your project, or, something specific to the theme of what you're building. [You can always update your collaborators](/builder/settings-collaborators#watch-how-to-invite-collaborators)  and coordinate across the internet so Avatars can be a stepping stone to trust.
