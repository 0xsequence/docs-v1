...
<div class="video-container">
    <img class="preview-image" src="/img/builder/builder_marketplace_preview_video.png" />
    <video class="video-frame" width="560" height="315" controls muted src="/video/builder/07_Marketplace.mp4" type="video/mp4" />
</div>