---
slug: /mint-collectibles-serverless
---
...
The following steps will guide you through how to build your self-hosted minter API in 4 steps:
...
If you want to browse the full code, see [an example implementation here](https://github.com/0xsequence-demos/cloudflare-worker-sequence-relayer/tree/simple-erc1155-mint-integration)
