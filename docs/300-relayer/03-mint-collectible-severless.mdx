...
Follow the prompts to create a `"Hello World" Worker` app with a generated name, then once logged in initialize the project in the project directory and follow the prompts to deploy your typescript application.
...
And if you want to view a live demo of a frontend integration, [see here](https://sequence.app)
