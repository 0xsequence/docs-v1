...
2. [Deploy, Sponsor and Update Metadata for an ERC1155 Contract with Builder](/relayer/mint-collectible-severless#2-deploy-sponsor-and-update-metadata-for-an-erc1155-contract-with-builder)
...
Next, you'll need to update the metadata with your media or assets for your contract, which can be done by following this [guide](https://hackmd.io/@taylanpince/rJGCaDs4a).
