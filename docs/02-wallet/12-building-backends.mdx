...
If you'd like to use the Sequence's Meta-Transaction capabilities, see [Building Relaying Server with Sequence](/build-with-sequence/building-relaying-server).