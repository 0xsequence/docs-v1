...
This property alongside the use of [UniversalDeployer](/wallet-contracts/universal-deployer) is the reason why Sequence wallets can obtain the same address on multiple chains.
