...
const wallet = sequence.initWallet(projectAccessKey, { defaultNetwork: 'mumbai' })
```
...
You can see a full list of supported test networks [here](/multi-chain-support#testnets).
