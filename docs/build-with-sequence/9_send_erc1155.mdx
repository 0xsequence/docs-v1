...
const data1 = erc1155Interface.encodeFunctionData('safeTransferFrom', [
  address, recipient1Address, token1Id, amount1, '0x'
])
const data2 = erc1155Interface.encodeFunctionData('safeTransferFrom', [
  address, recipient2Address, token2Id, amount2, '0x'
])
