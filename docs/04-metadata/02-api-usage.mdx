...
Quite simply, the Metadata API allows you to query the metadata of any ERC20, ERC721 or ERC1155
token on a [number of supported Ethereum chains](/multi-chain-support).
...
For the RPC client, we offer Web browser, node and Go clients.

As mentioned in the [example](#example) above.


token / contract metadata, etc..

For format of the REST endpoint is:
