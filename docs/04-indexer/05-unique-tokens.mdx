...
**Example: `GetTokenSupplies` of Skyweaver contract on Polygon using an `API_ACCESS_KEY`**
...
```bash class=wrap
curl -X POST -H "Content-Type: application/json" -H "X-Access-Key: API_ACCESS_KEY" https://polygon-indexer.sequence.app/rpc/Indexer/GetTokenSupplies -d '{ "contractAddress": "0x631998e91476DA5B870D741192fc5Cbc55F5a52E", "includeMetadata": true }'
```
