...
```
public void OnSignMessageCompleteHandler(SignMessageReturn result) {
    // Do something
}
...
```
_wallet.SignMessage(new SignMessageArgs(_wallet.GetAddress(), Chain.Polygon, "Message to sign"));
```
