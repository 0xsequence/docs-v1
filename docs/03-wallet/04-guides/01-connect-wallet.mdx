...
<img alt="Sequence on-demand sign in" src='/img/sign-in-fresh.png' />

<img alt="Sequence on-demand sign in, connect" src='/img/sign-in-connect.png' />
...
<img alt="Sequence Web3Modal Integration" src='/img/web3modal.png' />
...
<img alt="Sequence Chrome Extension" src='/img/seq-chrome-store.png' />
