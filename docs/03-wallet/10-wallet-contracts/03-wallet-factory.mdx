...
Sequence Wallets are created using the [Factory](https://github.com/0xsequence/wallet-contracts/blob/b084e731315582f6494bc169292bb89f379815ea/src/contracts/Factory.sol) contract, when called it creates child [MinimalUpgradeableProxies](https://github.com/0xsequence/wallet-contracts/blob/b084e731315582f6494bc169292bb89f379815ea/src/contracts/Wallet.sol) contracts, which are in essence the "boot" code of all Sequence wallets.
...
This property alongside the use of [UniversalDeployer](/wallet/wallet-contracts/universal-deployer) is the reason why Sequence wallets can obtain the same address on multiple chains.
